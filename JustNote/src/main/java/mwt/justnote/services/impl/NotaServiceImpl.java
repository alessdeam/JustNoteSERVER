...
public class NotaServiceImpl implements NotaService {
    ...
    private static final String INSERT_NOTA = "INSERT INTO note (titolo, contenuto, colore, id_utente, id_categoria) VALUES (?,?,?,?,?)";
    private static final String INSERT_NOTA_AREA = "INSERT INTO note (titolo, contenuto, colore, id_utente, id_categoria, id_area) VALUES (?,?,?,?,?,?)";
